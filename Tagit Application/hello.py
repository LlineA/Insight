...
def tag_output():
       ...
       model=tagit.load_model("word2vecDS_tag.model")
       popularity_dictionary=tagit.get_dictionary("popDict2")
       ...
       if tag_input.lower() == '':             
              ...
              #Get neighbours
              most_similar_tags=tagit.most_similar(tag_input.lower(),model)                   
              # Get number of followers
              follower_nb_to_beat=popularity_dictionary[tag_input.lower()]                
              # Find better tags
              better_choices_pop, better_choices_dist, sorted_tag_dict, list_better_choices_pop = tagit.find_more_popular_tags(most_similar_tags,
                                                                                                                            follower_nb_to_beat,
              ...
              recommendation_image_filename=tagit.create_word_cloud(better_choices_pop)
              return render_template("index.html",
                              tag_input=tag_input,
